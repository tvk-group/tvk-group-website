...
const GROUP_COMPANIES = [
  ...
  { id: 'labs', flag: '🇬🇧', title: 'TVK Labs & Technologies LTD', subtitle: 'Research & Development', role: 'R&D hub for blockchain, AI, cybersecurity and protocol development across the ecosystem.', focus: ['AI & protocol research', 'Software systems', 'Technical documentation', 'Innovation pipelines'], status: 'Active', url: 'https://tvklabs.com', img: 'tvklabs_logo.jpeg' },
...
const CONTENT = {
  en: {
    ...
    ecosystemLayerLead: 'One connected architecture spanning protocol, intelligence, finance, security, infrastructure, experiments and operations — presented directly in the website with no embedded window.',
